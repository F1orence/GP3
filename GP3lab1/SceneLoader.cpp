...
std::vector<Entity*> SceneLoader::LoadScene(int scene)
{
	...
	if (scene == 1)
	{
		...
		m_entities.push_back(new Entity()); // Point Light
		m_entities.at(m_entities.size() - 1)->GetTransform()->SetPosition(glm::vec3(-100, 0, -100));
		...
		m_entities.push_back(new Entity()); // Direction Light
		...
		m_entities.at(m_entities.size() - 1)->GetTransform()->SetPosition(glm::vec3(-50, 0, -100));
		m_entities.at(m_entities.size() - 1)->GetTransform()->SetScale(glm::vec3(0.4f, 0.4f, 0.4f));
		m_entities.at(m_entities.size() - 1)->GetTransform()->RotateEulerAxis(-90, m_entities.at(m_entities.size() - 1)->GetTransform()->GetUp());
		m_entities.at(m_entities.size() - 1)->GetTransform()->RotateEulerAxis(-20, m_entities.at(m_entities.size() - 1)->GetTransform()->GetRight());
	...
	#pragma region adding physics objects
		...
		a->GetTransform()->SetPosition(glm::vec3(0, 5, -18.f));
		a->AddComponent<RigidBody>();
		...
		for (int i = 0; i < 5; i++)
		{
			...
			a->GetComponent<MeshRenderer>()->SetSpecular(0.8f);
			a->GetTransform()->SetPosition(glm::vec3(0, -50, -50.f) + glm::vec3(0,0,-10 * i));
			a->AddComponent<RigidBody>();
			a->GetComponent<RigidBody>()->Init(new BoxShape(glm::vec3(1.f,5.f, 0.5f))); // 
			a->GetComponent<RigidBody>()->Get()->setMassProps(2.0f, btVector3(1, 1, 1));
			a->GetTransform()->SetScale(glm::vec3(1, 5, 0.5f));
			a->GetComponent<RigidBody>()->Get()->setFriction(1.0f);
		}

		m_entities.push_back(a = new Entity());
		a->AddComponent(new MeshRenderer(Resources::GetInstance()->GetModel("cube.obj"), Resources::GetInstance()->GetShader("ADS"), Resources::GetInstance()->GetTexture("WoodGrain.png"), 1));
		a->GetTransform()->SetPosition(glm::vec3(18, -33, -100));
		a->AddComponent<RigidBody>();
		...
		a->GetComponent<MeshRenderer>()->SetSpecular(0.8f);
		a->GetTransform()->SetPosition(glm::vec3(20, -35, -100));
		a->AddComponent<RigidBody>();
		...
		a->GetTransform()->SetPosition(glm::vec3(15, -28, -100));
		a->AddComponent<RigidBody>();
		a->GetComponent<RigidBody>()->Init(new BoxShape(glm::vec3(1.f, 1.f, 1.f)));
		...
		a->AddComponent(new MeshRenderer(Resources::GetInstance()->GetModel("cube.obj"), Resources::GetInstance()->GetShader("ADS"), Resources::GetInstance()->GetTexture("Wood.jpg"), 1));
		a->GetComponent<MeshRenderer>()->SetSpecular(0.7f);
		a->GetTransform()->SetPosition(glm::vec3(15, -35, -100));
		a->AddComponent<RigidBody>();
		a->GetComponent<RigidBody>()->Init(new BoxShape(glm::vec3(1.f, 1.f, 1.f)));
		...
		a->AddComponent(new MeshRenderer(Resources::GetInstance()->GetModel("sphere.obj"), Resources::GetInstance()->GetShader("ADS"), Resources::GetInstance()->GetTexture("WoodGrain.png"), 1));
		a->GetComponent<MeshRenderer>()->SetSpecular(0.8f);
		a->GetTransform()->SetPosition(glm::vec3(22, 0, -100));
		a->GetTransform()->SetScale(glm::vec3(0.1f, 0.1f, 0.1f));
		a->AddComponent<RigidBody>();
